<div class="mb-2">
    <div class="flex flex-row mb-2 space-x-3">
        <div class="flex flex-row space-x-0.5">
            <p>
                {{ $post->likeCount }}
            </p>
            <svg xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
            </svg>
        </div>
        <div class="flex flex-row space-x-0.5 align-middle">
            <p>
                {{ $commentsCount }}
            </p>
    ...
    <div class="flex flex-row">
        ...
        <button wire:click="decrement"
            class="focus:outline-none text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
