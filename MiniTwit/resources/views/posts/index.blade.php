    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md mx-10 mt-10 bg-white">
                ...
                <div class="w-full rounded overflow-hidden shadow-lg">
                    ...
                    <div class="py-2 ml-6">
                        <div class="container py-2 mx-0 min-w-full flex flex-col">
                            @livewire('likes-counter', ['post' => $post], key($post->id))
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-4 px-10 mx-0 min-w-full flex flex-col items-center">
            <form action="{{ route('posts.create') }}" method="GET">
                <button type="submit"
                    class="fixed z-90 bottom-10 right-8 bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 w-16 h-16 rounded-full drop-shadow-lg flex justify-center items-center text-white text-medium"><svg
